...
alias emacs-packages-upgrade='emacs --batch --eval "(progn (load-file \"$HOME/.emacs\") (package-upgrade-all))"'
alias emacs-packages-install='emacs --batch --eval "(progn (load-file \"$HOME/.emacs\") (install-selected-packages))"'
