...
alias epu='emacs --batch --eval "(progn (load-file \"$HOME/.emacs\") (package-upgrade-all))"'
alias epi='emacs --batch --eval "(progn (load-file \"$HOME/.emacs\") (install-selected-packages))"'
