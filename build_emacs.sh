...
apt-get install -y $TOOLKIT_PACKAGE libgnutls28-dev libncurses5-dev libxpm-dev libjpeg-dev libtiff5-dev libpng-dev libgif-dev libxml2-dev libxft-dev libfreetype6-dev
